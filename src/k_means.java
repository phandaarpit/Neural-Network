...
//	static int n, p;
//
//	static int cal_diff(int a) // This method will determine the cluster in
//								// which an element go at a particular step.
//	{
//		int temp1 = 0;
//		for (int i = 0; i < p; ++i) {
//			if (a > m[i])
...
//	}
//
//	static void cal_mean() // This method will determine intermediate mean
//							// values
//	{
//		for (int i = 0; i < p; ++i)
...
//	}
//
//	static int check1() // This checks if previous k ie. tempk and current k are
//						// same.Used as terminating case.
//	{
//		for (int i = 0; i < p; ++i)
//			for (int j = 0; j < n; ++j)
//				if (tempk[i][j] != k[i][j]) {
...
//					k[temp][count3++] = d[i];
//			}
//			cal_mean(); // call to method which will calculate mean at this
//						// step.
